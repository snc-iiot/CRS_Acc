...
const CopyToClipboardCustom = forwardRef<HTMLDivElement, Props>(({ text = "", delay = 1000, className = "" }, ref) => {
  ...
  return (
    <div ref={ref}>
      <div className="relative overflow-hidden">
        ...
        />
        <Icons.check ref={afterRef} className={cn("hidden text-green-600", className)} />
        <input ref={inputRef} type="text" defaultValue={text} className="absolute right-[1000px] top-0" />
      </div>
    </div>
  );
});
