                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="yes"
                            id={`${companyPoliciesId}_have_${i + 1}`}
                          />
                          <Label htmlFor={`${companyPoliciesId}_have_${i + 1}`}>
                            มี
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="no"
                            id={`${companyPoliciesId}_dontHave_${i + 1}`}
                          />
                          <Label
                            htmlFor={`${companyPoliciesId}_dontHave_${i + 1}`}
                          >
                            ไม่มี
                          </Label>
                        </div>
