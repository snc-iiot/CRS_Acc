    ...
    function create(Request $request)
    {
        try {
            ...
            DB::table("tb_general_assessments")->where("regis_id", $request->regis_id)->update([
                ...
                "price_conditions" => \json_encode($request->price_conditions, JSON_UNESCAPED_UNICODE),
                "machine_produce" => \json_encode($request->machine_produce, JSON_UNESCAPED_UNICODE),
                "mold_use" => \json_encode($request->mold_use, JSON_UNESCAPED_UNICODE),
                "main_material" => \json_encode($request->main_material, JSON_UNESCAPED_UNICODE),
                "transport_distance" => \json_encode($request->transport_distance, JSON_UNESCAPED_UNICODE),
                "main_supplier_credit_terms" => \json_encode($request->main_supplier_credit_terms, JSON_UNESCAPED_UNICODE),
                "main_mat_ratio" => \json_encode($request->main_mat_ratio, JSON_UNESCAPED_UNICODE),
                "ratio_of_raw_mat" => \json_encode($request->ratio_of_raw_mat, JSON_UNESCAPED_UNICODE),
                "inventory_day" => \json_encode($request->inventory_day, JSON_UNESCAPED_UNICODE),
                "approvals" => \json_encode($request->approvals, JSON_UNESCAPED_UNICODE),
    ...
    function update(Request $request)
    {
        try {
            ...
            DB::table("tb_general_assessments")->where("regis_id", $request->regis_id)->update([
                ...
                "ratio_of_raw_mat" => \json_encode($request->ratio_of_raw_mat, JSON_UNESCAPED_UNICODE),
                "inventory_day" => \json_encode($request->inventory_day, JSON_UNESCAPED_UNICODE),
                "approvals" => \count($approvals) == 0 ? null : \json_encode($approvals, JSON_UNESCAPED_UNICODE),
